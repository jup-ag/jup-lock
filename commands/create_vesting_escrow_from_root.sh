...
target/debug/cli --rpc-url $rpc_url --program-id $program_id --keypair-path $keypair_path create-vesting-ecrow-from-root --merkle-tree-path $merkle_tree_path --base $base --mint $mint