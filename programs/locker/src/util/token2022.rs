...
use crate::{LockerError, TokenBadge, VestingEscrow};
...
pub fn validate_mint(token_mint: &InterfaceAccount<Mint>, token_badge: &UncheckedAccount) -> Result<bool> {
...
fn is_token_badge_initialized(
    token_mint_key: Pubkey,
    token_badge: &UncheckedAccount,
) -> Result<bool> {
    ...
    Ok(token_badge.token_mint == token_mint_key)
}
